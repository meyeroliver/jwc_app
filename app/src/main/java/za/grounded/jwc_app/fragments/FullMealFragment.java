...
public class FullMealFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_full_meal, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(FullMealFragment.super.getContext()));
        recyclerView.setHasFixedSize(true);
        productAdapter = new ProductAdapter();
        recyclerView.setAdapter(productAdapter);

        landingViewModel.getCategorizedProjectList("full").observe(getViewLifecycleOwner(), products -> {
            if (products != null) {
    ...
    public void onStart() {
        ...
        productAdapter.getOnClickedProduct().observe(getViewLifecycleOwner(),s -> {
            Toast.makeText(FullMealFragment.super.getContext(), s, Toast.LENGTH_SHORT).show();
